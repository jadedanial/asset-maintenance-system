...
const Employee = (props) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'update',
      key: 'update',
      render: () => <Button type="primary" className="custom-hover" icon={<EditOutlined />} />,
    },
  ];
        ...
        <Card {...cardlayout}>
          <Row>
            <Col span={24}>
              <Card size="small" style={{background: "#318CE7", width: "100%"}}>
                <Row>
                  <Col span={2}>
                    <Tooltip title="New Employee"><Button type="primary" shape="circle" className="custom-hover" style={{margin: "0 20px"}} onClick={() => {showDrawer(); setCompItem(2)}} icon={<UserAddOutlined />} /></Tooltip>
                  </Col>
                  <Col span={19}>
          ...
          <Row style={{marginTop: "20px"}}>
            <Col span={24}>
              ...
              onRow={(rowIndex) => {return {onClick: (event) => {showDrawer(); setEmpID(rowIndex.employee); setCompItem(1)},};}} pagination={{pageSize: 10, showSizeChanger: true,
              pageSizeOptions: ['10', '20', '30']}} size="small" scroll={{y: 400}} />
            </Col>
          </Row>
        </Card>
      </Row>
